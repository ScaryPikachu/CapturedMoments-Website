...
<head>
  ...
  <meta name="keywords" content="">
    ...
    <!-- Favicons -->
    <link href="{{ asset('img/Pikachu-Cap.png') }}" rel="icon">
  ...
  <header id="header" class="header d-flex align-items-center sticky-top">
    <div class="container-fluid position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center me-auto me-xl-0">
        ...
        <h1 class="sitename">Capture Moments</h1>
      </a>
  ...
  <footer id="footer" class="footer">
    ...
    <div class="container">
      <div class="copyright text-center ">
        <p>© <span>Copyright</span> <strong class="px-1 sitename">Capture Moments</strong> <span>All Rights Reserved</span></p>
      </div>
      ...
      <div class="credits">
        ...
        Developed by <a href="https://www.github.com/anandacdr">Ananda Chaudhary</a>
      </div>
    </div>
